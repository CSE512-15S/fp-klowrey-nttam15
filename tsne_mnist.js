...
var net_opt ={'name':'no_conv_mnist', 'node_scale':10, 'link_scale':4, 'link_opcty':2}
var collapse_input = true;
helper.dataToSankey(net, points, net_opt, 'data/mnist_sankey_v2.json', collapse_input);
