d3.sankey = function() {
   ...
   sankey.size = function(_) {
      ...
      width  = size[0];
      height = size[1];
      console.log("sankey w, h: "+width+", "+height);
      return sankey;
   };
   ...
   function computeNodeValues() {
      // TODO should node value represent cluster size?
      nodes.forEach(function(node) {
         //node.value = Math.max(
         //   d3.sum(node.sourceLinks, value),
         //   d3.sum(node.targetLinks, value)
         //);
         // Node gets value from tSNE -- should relate to vertical position
      });
   }
      ...
      */
      ...
      function initializeNodeDepth() {
         ...
         links.forEach(function(link) {
            ...
            // TODO figure out the link co-activation
            // either as width or opacity?
            //link.dy = link.value*ky;
            link.dy = 50;
         });
      }
